...
```typescript
import { OAuthErrorResponse } from "@midday-ai/sdk/models/errors";
...
| `state`                                          | *string*                                         | :heavy_minus_sign:                               | Opaque state parameter from the original request | abc123xyz789_secure-random-state-value           |