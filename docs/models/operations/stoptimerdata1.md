...
```typescript
import { StopTimerData1 } from "@midday-ai/sdk/models/operations";

let value: StopTimerData1 = {
...
| `stop`                                                                                                       | *string*                                                                                                     | :heavy_check_mark:                                                                                           | Stop time of the tracker entry in ISO 8601 format. Null for running timers.                                  | 2024-04-15T17:00:00.000Z                                                                                     |
...
| `project`                                                                                                    | [operations.StopTimerProject1](../../models/operations/stoptimerproject1.md)                                 | :heavy_check_mark:                                                                                           | Project information associated with this tracker entry                                                       |                                                                                                              |