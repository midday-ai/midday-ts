...
export function desktopCheckUpdate(
  ...
  Result<
    operations.CheckDesktopUpdateResponse,
    | errors.CheckDesktopUpdateBadGatewayError
    | MiddayError
...
> {
  const path = pathToFunc("/desktop/update")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CheckDesktopUpdateResponse$inboundSchema),
    M.jsonErr(502, errors.CheckDesktopUpdateBadGatewayError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
