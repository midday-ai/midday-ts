...
export function documentsDelete(
  ...
  Result<
    operations.DeleteDocumentResponse,
    | MiddayError
...
> {
  ...
  const path = pathToFunc("/documents/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteDocumentResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.DeleteDocumentResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
