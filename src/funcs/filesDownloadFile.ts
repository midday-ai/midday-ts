 ...
 */
export function filesDownloadFile(
  client: MiddayCore,
  ...
  Result<
    ...
    | errors.DownloadFileInternalServerError
    | MiddayError
...
> {
  ...
  const path = pathToFunc("/files/download/file")();
  ...
  >(
    ...
    M.jsonErr(400, errors.DownloadFileBadRequestError$inboundSchema),
    M.jsonErr(401, errors.DownloadFileUnauthorizedError$inboundSchema),
    M.jsonErr(404, errors.DownloadFileNotFoundError$inboundSchema),
    M.jsonErr(500, errors.DownloadFileInternalServerError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
