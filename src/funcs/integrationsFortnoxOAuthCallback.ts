...
export function integrationsFortnoxOAuthCallback(
  ...
  Result<
    operations.FortnoxOAuthCallbackResponse | undefined,
    | MiddayError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.FortnoxOAuthCallbackRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/apps/fortnox/oauth-callback")();
  ...
  >(
    M.nil(
      302,
      operations.FortnoxOAuthCallbackResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
    M.fail([400, "4XX"]),
    M.fail("5XX"),
