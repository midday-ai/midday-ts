 ...
 */
export function integrationsGetFortnoxInstallUrl(
  client: MiddayCore,
...
> {
  const path = pathToFunc("/apps/fortnox/install-url")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetFortnoxInstallUrlResponse$inboundSchema),
    M.fail([401, "4XX"]),
    M.fail([500, "5XX"]),
  )(response, req);
  if (!result.ok) {
