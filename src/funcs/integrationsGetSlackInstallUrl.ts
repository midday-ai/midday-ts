 ...
 */
export function integrationsGetSlackInstallUrl(
  client: MiddayCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetSlackInstallUrlResponse,
    | MiddayError
...
> {
  const path = pathToFunc("/apps/slack/install-url")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetSlackInstallUrlResponse$inboundSchema),
    M.fail([401, "4XX"]),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
