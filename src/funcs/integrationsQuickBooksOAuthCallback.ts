 ...
 */
export function integrationsQuickBooksOAuthCallback(
  client: MiddayCore,
  request: operations.QuickBooksOAuthCallbackRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.QuickBooksOAuthCallbackResponse | undefined,
    | MiddayError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.QuickBooksOAuthCallbackRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/apps/quickbooks/oauth-callback")();
  ...
  >(
    M.nil(
      302,
      operations.QuickBooksOAuthCallbackResponse$inboundSchema.optional(),
      { hdrs: true },
    ),
    M.fail([400, "4XX"]),
    M.fail("5XX"),
