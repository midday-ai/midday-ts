...
export function integrationsXeroOAuthCallback(
  ...
  Result<
    operations.XeroOAuthCallbackResponse | undefined,
    | MiddayError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.XeroOAuthCallbackRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/apps/xero/oauth-callback")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.nil(302, operations.XeroOAuthCallbackResponse$inboundSchema.optional(), {
      hdrs: true,
    }),
    M.fail([400, "4XX"]),
    M.fail("5XX"),
