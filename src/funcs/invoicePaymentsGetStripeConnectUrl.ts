 ...
 */
export function invoicePaymentsGetStripeConnectUrl(
  client: MiddayCore,
...
> {
  const path = pathToFunc("/invoice-payments/connect-stripe")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetStripeConnectUrlResponse$inboundSchema),
    M.fail([401, "4XX"]),
    M.fail([500, "5XX"]),
  )(response, req);
  if (!result.ok) {
