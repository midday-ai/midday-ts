...
export function invoicesCreate(
  ...
  Result<
    ...
    | errors.CreateInvoiceBadRequestError
    | errors.CreateInvoiceNotFoundError
    | errors.ConflictError
    | errors.CreateInvoiceInternalServerError
    | MiddayError
...
> {
  ...
  >(
    ...
    M.jsonErr(400, errors.CreateInvoiceBadRequestError$inboundSchema),
    M.jsonErr(404, errors.CreateInvoiceNotFoundError$inboundSchema),
    M.jsonErr(409, errors.ConflictError$inboundSchema),
    M.jsonErr(500, errors.CreateInvoiceInternalServerError$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
