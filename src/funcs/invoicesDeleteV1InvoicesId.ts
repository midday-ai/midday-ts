 ...
 */
export function invoicesDeleteV1InvoicesId(
  client: MiddayCore,
  request: operations.DeleteV1InvoicesIdRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.DeleteV1InvoicesIdResponse,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteV1InvoicesIdRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "delete_/v1/invoices/{id}",
    oAuth2Scopes: [],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteV1InvoicesIdResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response);
  if (!result.ok) {
