 ...
 */
export function oAuthPostOAuthRegister(
  client: MiddayCore,
  request: operations.PostOAuthRegisterRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PostOAuthRegisterResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PostOAuthRegisterRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/oauth/register")();
