...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetExpensesReportsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/reports/expenses")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetExpensesReportsResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetExpensesReportsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
