...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetProfitReportsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/reports/profit")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetProfitReportsResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetProfitReportsResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
