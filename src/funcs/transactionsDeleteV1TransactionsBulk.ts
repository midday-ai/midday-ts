 ...
 */
export function transactionsDeleteV1TransactionsBulk(
  client: MiddayCore,
  request?: Array<string> | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    Array<operations.DeleteV1TransactionsBulkResponse>,
    | APIError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const context = {
    ...
    operationID: "delete_/v1/transactions/bulk",
    oAuth2Scopes: [],
  ...
  >(
    M.json(
      200,
      z.array(operations.DeleteV1TransactionsBulkResponse$inboundSchema),
    ),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response);
