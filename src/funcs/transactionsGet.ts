...
export function transactionsGet(
  ...
  Result<
    operations.GetTransactionByIdResponse,
    | MiddayError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetTransactionByIdResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.GetTransactionByIdResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
