 ...
 */
export function transactionsPatchV1TransactionsId(
  client: MiddayCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PatchV1TransactionsIdRequest$outboundSchema.parse(value),
  ...
  const context = {
    ...
    operationID: "patch_/v1/transactions/{id}",
    oAuth2Scopes: [],
