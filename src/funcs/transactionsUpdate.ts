...
export function transactionsUpdate(
  ...
  Result<
    operations.UpdateTransactionResponse,
    | MiddayError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateTransactionResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.json("default", operations.UpdateTransactionResponse$inboundSchema),
  )(response, req);
  if (!result.ok) {
