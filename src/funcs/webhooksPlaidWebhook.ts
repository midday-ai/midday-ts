 ...
 */
export function webhooksPlaidWebhook(
  client: MiddayCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PlaidWebhookResponse,
    | MiddayError
...
> {
  const path = pathToFunc("/webhook/plaid")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PlaidWebhookResponse$inboundSchema),
    M.fail([400, 401, "4XX"]),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
