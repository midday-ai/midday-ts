 ...
 */
export function webhooksPolarWebhook(
  client: MiddayCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.PolarWebhookResponse,
    | MiddayError
...
> {
  const path = pathToFunc("/webhook/polar")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.PolarWebhookResponse$inboundSchema),
    M.fail([400, "4XX"]),
    M.fail([500, "5XX"]),
  )(response, req);
  if (!result.ok) {
