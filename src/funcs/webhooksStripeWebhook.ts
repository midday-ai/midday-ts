 ...
 */
export function webhooksStripeWebhook(
  client: MiddayCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.StripeWebhookResponse,
    | MiddayError
...
> {
  const path = pathToFunc("/webhook/stripe")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.StripeWebhookResponse$inboundSchema),
    M.fail([400, "4XX"]),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
