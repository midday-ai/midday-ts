 ...
 */
export function webhooksTellerWebhook(
  client: MiddayCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.TellerWebhookResponse,
    | MiddayError
...
> {
  const path = pathToFunc("/webhook/teller")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TellerWebhookResponse$inboundSchema),
    M.fail([400, 401, "4XX"]),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
