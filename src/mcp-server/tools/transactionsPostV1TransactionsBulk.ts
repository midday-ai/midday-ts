...
export const tool$transactionsPostV1TransactionsBulk: ToolDefinition<
  typeof args
> = {
  name: "transactions-post-v1-transactions-bulk",
  description: `Bulk create transactions

Bulk create transactions for the authenticated team.`,
  args,
  tool: async (client, args, ctx) => {
    const [result, apiCall] = await transactionsPostV1TransactionsBulk(
      client,
      args.request,
