...
/** @internal */
export const GetCustomerByIdResponseBody$inboundSchema: z.ZodType<
  GetCustomerByIdResponseBody,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type GetCustomerByIdResponseBody$Outbound = {
  id: string;
  name: string;
  email: string;
  billingEmail: string | null;
...
/** @internal */
export const GetCustomerByIdResponseBody$outboundSchema: z.ZodType<
  GetCustomerByIdResponseBody$Outbound,
  z.ZodTypeDef,
  GetCustomerByIdResponseBody
> = z.object({
  id: z.string(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace GetCustomerByIdResponseBody$ {
  /** @deprecated use `GetCustomerByIdResponseBody$inboundSchema` instead. */
  export const inboundSchema = GetCustomerByIdResponseBody$inboundSchema;
  /** @deprecated use `GetCustomerByIdResponseBody$outboundSchema` instead. */
  export const outboundSchema = GetCustomerByIdResponseBody$outboundSchema;
  /** @deprecated use `GetCustomerByIdResponseBody$Outbound` instead. */
  export type Outbound = GetCustomerByIdResponseBody$Outbound;
}

export function getCustomerByIdResponseBodyToJSON(
  getCustomerByIdResponseBody: GetCustomerByIdResponseBody,
): string {
  return JSON.stringify(
    GetCustomerByIdResponseBody$outboundSchema.parse(
      getCustomerByIdResponseBody,
    ),
  );
}
...
export const GetCustomerByIdResponse$inboundSchema: z.ZodType<
  ...
  unknown
> = z.union([
  z.lazy(() => GetCustomerByIdResponseBody$inboundSchema),
...
export const GetCustomerByIdResponse$outboundSchema: z.ZodType<
  ...
  GetCustomerByIdResponse
> = z.union([
  z.lazy(() => GetCustomerByIdResponseBody$outboundSchema),
